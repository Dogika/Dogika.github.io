...
function MoveTowardBehavior(timestamp, maxSpeed, acceleration, friction) {
    this.type = "moveToward";
    this.timestamp = timestamp;
...
function SniperMovementBehavior(timestamp, maxSpeed, acceleration, friction, minDist, maxDist, seperationFactor) {
    this.type = "sniper";
    this.timestamp = timestamp;
    this.maxSpeed = maxSpeed;
    this.acceleration = acceleration;
